...
data_folder = '/Users/dmanral/Desktop/Analysis/Ridley/'
...
for ind in stations.index:
    ...
    for tc_index, tc in enumerate(['10C', '12C', '14C']):
        ...
        for i, w in enumerate(winds):
            ...
            ds_days = full_ds[ind, :, 2, tc_index].flatten()
            ds_dist = full_ds[ind, :, 3, tc_index].flatten()
    ...
    fig.update_layout(height=1000, width=1200,
                      title_text="Cold stunning event for different Windage settings: {0}".format(stations['Location'][ind]),
                      ...
                      legend_font_size=20)
    # fig.show()
    fig.write_image(home_folder + 'windage_{0}.jpeg'.format(stations['Location'][ind]), scale=5)
